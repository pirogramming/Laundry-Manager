...
# # 두 투영을 순차 시도: KATEC(2097) -> UTM-K(5179)
...
#     # 컬럼명 (파일 정의 참고: X/Y=좌표정보, 도로명주소/지번주소, 영업상태명) :contentReference[oaicite:2]{index=2}
#     out = []
#     for r in rows:
#         if r.get("trdstatenm") != "영업/정상":  # 영업만 사용 :contentReference[oaicite:3]{index=3}
#             continue
...
#         lat, lng = ll
#         out.append({
#             "name": r.get("bplcnm"),                              # 사업장명
#             "addr": r.get("rdnwhladdr") or r.get("sitewhladdr"),  # 도로명 > 지번
#             "lat": lat,
#             "lng": lng,
#         })
